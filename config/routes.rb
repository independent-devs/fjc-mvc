...
#                shipping_details_checkout PATCH    /checkout/:id/shipping_details(.:format)                                                          checkouts#shipping_details
#                  payment_method_checkout PATCH    /checkout/:id/payment_method(.:format)                                                            checkouts#payment_method
