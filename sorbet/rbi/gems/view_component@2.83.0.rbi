...
class ViewComponent::Base < ::ActionView::Base
  ...
  #
  # source://view_component//lib/view_component/base.rb#155
  ...
  # source://view_component//lib/view_component/base.rb#345
  def compiler; end
  ...
  # source://view_component//lib/view_component/base.rb#339
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://view_component//lib/view_component/base.rb#545
    def compiled?; end
    ...
    # @private
    #
    # source://view_component//lib/view_component/base.rb#575
    def identifier; end
    ...
    # @private
    #
    # source://view_component//lib/view_component/base.rb#437
...
class ViewComponent::Compiler
  ...
  # source://view_component//lib/view_component/compiler.rb#200
  def inline_calls; end

  # source://view_component//lib/view_component/compiler.rb#215
  def inline_calls_defined_on_self; end

  # source://view_component//lib/view_component/compiler.rb#257
  ...
  # @return [Boolean]
  #
  # source://view_component//lib/view_component/compiler.rb#261
  def should_compile_superclass?; end

  # source://view_component//lib/view_component/compiler.rb#118
  def template_errors; end

  # source://view_component//lib/view_component/compiler.rb#184
  def templates; end
